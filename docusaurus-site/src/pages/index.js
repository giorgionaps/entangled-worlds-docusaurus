...
import { Rocket, ClipboardList, Briefcase } from "lucide-react";
          ...
          <div className="row home-cards">
            <div className="col col--4">
              <div className="card card--full-height">
                ...
                <div className="card__footer">
                  <Link className="button button--link" to={useBaseUrl('/docs/install')}>
                    Installation guide →
                  </Link>
                </div>
              </div>
            ...
            <div className="col col--4">
              <div className="card card--full-height">
                ...
                <div className="card__footer">
                  <Link className="button button--link" to={useBaseUrl('/docs/release-notes')}>
                    View release notes →
                  </Link>
                </div>
              </div>
            ...
            <div className="col col--4">
              <div className="card card--full-height">
                ...
                <div className="card__footer">
                  <Link className="button button--link" to={useBaseUrl('/work-samples')}>
                    View work samples →
                  </Link>
                </div>
              </div>
